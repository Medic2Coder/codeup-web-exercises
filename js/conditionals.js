...
// console.log(analyzeColor(color: "Blue"));
// console.log(analyzeColor(color: "cyan"));

// This is example from class, still doesn't work in console, syntax error? ^ fixed now
...
function calculateTotal(luckyNumber, totalAmount)
{
    ...
    let discountPercentage; //initializing if statement, so make sure this variable exists before the if statment
    if (luckyNumber = 0) {
...
var luckyNumber = Math.floor(x:Math)
